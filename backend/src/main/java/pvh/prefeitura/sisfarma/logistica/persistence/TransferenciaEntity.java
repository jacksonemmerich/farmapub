...
public class TransferenciaEntity {
    ...
    private List<TransferenciaAlocacaoEntity> alocacoes = new ArrayList<>();
    ...
    public List<TransferenciaAlocacaoEntity> getAlocacoes() {
        return alocacoes;
    }

    public void setAlocacoes(List<TransferenciaAlocacaoEntity> alocacoes) {
